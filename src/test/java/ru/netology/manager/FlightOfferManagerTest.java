...
import ru.netology.domain.FlightOfferByTimeComparator;
...
class FlightOfferManagerTest {
    ...
    FlightOffer third = new FlightOffer(3, 3000, "DME", "LED", 120);
    FlightOffer fourth = new FlightOffer(4, 3000, "DME", "LED", 90);
    ...
    @Test
    void searchTwoItemsByTime() {
        FlightOffer[] offers = flightOfferManager.searchBy("DME", "LED", new FlightOfferByTimeComparator());
        FlightOffer[] expected = {fourth, third};
        assertArrayEquals(expected, offers);
    }
